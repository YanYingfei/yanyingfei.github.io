...
<img src="./pics/functionality-sig.png" alt="functionality-sig">
...
<img src="./pics/functionality-sim-sok.png" alt="functionality-sim-sok">
...
$$\begin{equation} \middle| \begin{aligned} Pr[(\mathsf{pp},\tau) \gets \mathsf{Simsetup}(\lambda); b\gets \mathcal{A}^{\mathsf{Simsign}(\mathsf{pp}, \tau,\cdot)}(s,\mathsf{pp}): b=1] \\ - Pr[\mathsf{pp} \gets \mathsf{Setup}(\lambda); b\gets \mathcal{A}^{\mathsf{Sign}(\mathsf{pp}, \cdot)}(s,\mathsf{pp}): b=1]\end{aligned} \middle|= \nu{\lambda}, \end{equation}$$
