...
- density$$\begin{equation}\sigma \leq|S| / |\mathsf{D}| \end{equation}$$，
- 存在$v_1, ..., v_k \in V$，使得，
...
$\mathcal{V}$接受的概率
大于 \begin{equation} \epsilon_{total} = \frac{\ell}{|\mathbb{K}|} + \frac{(d_{max}+2^h + a) \cdot \ell}{|\mathbb{K}|-a|\mathsf{D}| + |\mathsf{H}_0|} + \epsilon_{\mathsf{FRI}}(q,n,\rho, m,s,\vec{t}), \end{equation} 其中整数$m \geq 2, \ell=m / \rho$.
